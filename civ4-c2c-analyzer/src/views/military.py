...
def display_military_analysis(df_player_stats, selected_players, turn_range, players_data):
    ...
    with st.expander("Show/Hide Graph Options", expanded=False):
        show_military_strength_comparison = st.checkbox(
            "Show military strength comparison",
            value=GRAPH_CONFIG["military"]["show_military_strength_comparison"]
        )
        show_total_units_evolution = st.checkbox(
            "Show total units evolution",
            value=GRAPH_CONFIG["military"]["show_total_units_evolution"]
        )
        show_unit_type_repartition_history = st.checkbox(
            "Show unit type repartition history",
            value=GRAPH_CONFIG["military"]["show_unit_type_repartition_history"]
        )
        show_unit_ai_type_repartition_history = st.checkbox(
            "Show AI type repartition history",
            value=GRAPH_CONFIG["military"]["show_unit_ai_type_repartition_history"]
        )
        show_specific_unit_types_evolution = st.checkbox(
            "Show specific unit types evolution",
            value=GRAPH_CONFIG["military"]["show_specific_unit_types_evolution"]
        )
        show_most_popular_unit_types = st.checkbox(
            "Show most popular unit types",
            value=GRAPH_CONFIG["military"]["show_most_popular_unit_types"]
        )
        show_military_repartition_by_unit_type = st.checkbox(
            "Show military repartition by unit type",
            value=GRAPH_CONFIG["military"]["show_military_repartition_by_unit_type"]
        )
        show_military_repartition_by_ai_type = st.checkbox(
            "Show military repartition by AI type",
            value=GRAPH_CONFIG["military"]["show_military_repartition_by_ai_type"]
        )
        show_civil_units_repartition_by_ai_type = st.checkbox(
            "Show civil units repartition by AI type",
            value=GRAPH_CONFIG["military"]["show_civil_units_repartition_by_ai_type"]
        )
    ...
    if show_military_strength_comparison:
    ...
    if all_units:
        ...
        if not df_units_filtered.empty:
            ...
            if show_unit_type_repartition_history:
            ...
            if show_unit_ai_type_repartition_history:
            ...
            if show_specific_unit_types_evolution:
            ...
            if show_most_popular_unit_types:
            ...
            if show_military_repartition_by_unit_type:
            ...
            if show_military_repartition_by_ai_type:
